...
function getProperties(placemark, schemas) {
    ...
    // extendeddata
    var extended = placemark.findtext('./ExtendedData');
    if(extended) {properties.extended = extended; }

    // styleUrl
    var style = placemark.findtext('./styleUrl');
    if(style.indexOf("#poly") !== -1) {
        properties.style = style.substring(6, 12);
    }
